...
namespace SPG.Data.EventSource.Storage
{
    public abstract class EventstoreStorageProviderBase
    {
        ...
        protected static IEvent DeserializeEvent(ResolvedEvent returnedEvent)
        {
            ...
            return
                (EventSourcing.Event.Event)JsonConvert.DeserializeObject(Encoding.UTF8.GetString(returnedEvent.Event.Data), returnType,
        ...
        protected static EventSourcing.Snapshot.Snapshot DeserializeSnapshotEvent(ResolvedEvent returnedEvent)
        {
            ...
            return
                (EventSourcing.Snapshot.Snapshot)JsonConvert.DeserializeObject(Encoding.UTF8.GetString(returnedEvent.Event.Data), returnType,
                        GetSerializerSettings());
        }
        ...
        {
            return @event.GetType() + "," + @event.GetType().GetTypeInfo().Assembly.GetName().Name;
        }
    }
}